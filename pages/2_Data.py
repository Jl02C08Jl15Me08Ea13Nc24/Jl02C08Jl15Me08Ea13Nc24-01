...
# Load data
try:
    df = deploy.load_csv_data(FPATHS['data']['filtered']['sales_predictions_2023_preprocessing.csv'])
    data_loaded = True
    st.success("Data loaded successfully! You can now explore the dataset using the sidebar by selecting columns, choosing operations, and executing custom queries.")
